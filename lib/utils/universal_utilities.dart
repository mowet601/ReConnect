...
class UniversalVariables {
  static final Color blueColor = Color(0xffFFDD00);
  ...
  static final Color lightBlueColor = Color(0xffFBB034);
  static final Color separatorColor = Color(0xff272c35);

  static final Color gradientColorStart = Color(0xffFFDD00);
  static final Color gradientColorEnd = Color(0xffFBB034);
